...
export function MobileMenuDrawer({ currentPage, onClose }: MobileMenuDrawerProps) {
  ...
  const mainNavigationLinks = [
    ...
    { href: "/website/people-concierge", label: "People", active: (currentPage === "people-concierge" || currentPage === "people-experts" || currentPage === "people-partners"), hasDropdown: true },
  ...
  const peopleSubLinks = [
    ...
    { href: "/website/people-partners", label: "Partner Network" }
  ]

  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error && typeof error === 'object' && 'code' in error && error.code === 'PGRST205') {
        ...
        alert('A press release with this title already exists. Please choose a different title.')
      } else {
        ...
        alert(`Error creating press release: ${errorMessage}. Please try again.`)
      }
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">New Press Release</h1>
          <p className="text-muted-foreground">
            Create a new press release article
          </p>
        </div>
      </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., Funding, Product, Partnership"
                  />
                </div>
                <div className="space-y-2">

          ...
          <Section paddingY="lg">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  All available variants, patterns, and configuration options for error handling and feedback systems.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue="errorTypes" className="w-full">
                  <TabsList className="grid w-full grid-cols-6">
                    <TabsTrigger value="errorTypes">Error Types</TabsTrigger>
                    <TabsTrigger value="validation">Validation</TabsTrigger>
                    <TabsTrigger value="feedback">Feedback</TabsTrigger>
                    <TabsTrigger value="boundaries">Boundaries</TabsTrigger>
                    <TabsTrigger value="alerts">Alerts</TabsTrigger>
                    <TabsTrigger value="emptyStates">Empty States</TabsTrigger>
                  </TabsList>

                  <TabsContent value="errorTypes" className="space-y-6">
                    <div>
                      <H4 className="mb-3">Error Type Variants</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.errorTypes.variants.map((variant) => (
                    ...
                    <div>
                      <H4 className="mb-3">Error Severities</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.errorTypes.severities.map((severity) => (
                          <div key={severity.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{severity.name}</div>
                  ...
                  <TabsContent value="validation" className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.validationPatterns.modes.map((mode) => (
                    ...
                    <div>
                      <H4 className="mb-3">Error Positions</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.validationPatterns.positions.map((position) => (
                  ...
                  <TabsContent value="feedback" className="space-y-6">
                    <div>
                      <H4 className="mb-3">Feedback Variants</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.feedbackTypes.variants.map((variant) => (
                          <div key={variant.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{variant.name}</div>
                            <div className="text-xs text-muted-foreground">{variant.description}</div>
                          </div>
                    ...
                    <div>
                      <H4 className="mb-3">Feedback Positions</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.feedbackTypes.positions.map((position) => (
                          <div key={position.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{position.name}</div>
                            <div className="text-xs text-muted-foreground">{position.description}</div>
                          </div>
                    ...
                    <div>
                      <H4 className="mb-3">Feedback Animations</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.feedbackTypes.animations.map((animation) => (
                  ...
                  <TabsContent value="boundaries" className="space-y-6">
                    <div>
                      <H4 className="mb-3">Fallback Types</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.errorBoundaries.fallbackTypes.map((fallback) => (
                          <div key={fallback.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{fallback.name}</div>
                            <div className="text-xs text-muted-foreground">{fallback.description}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      <H4 className="mb-3">Error Reporting Services</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.errorBoundaries.services.map((service) => (
                  ...
                  <TabsContent value="alerts" className="space-y-6">
                    <div>
                      <H4 className="mb-3">Alert Variants</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.alerts.variants.map((variant) => (
                          <div key={variant.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{variant.name}</div>
                            <div className="text-xs text-muted-foreground">{variant.description}</div>
                          </div>
                    ...
                    <div>
                      <H4 className="mb-3">Alert Sizes</H4>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        {config.alerts.sizes.map((size) => (
                          <div key={size.id} className="p-3 border rounded-lg">
                            <div className="font-medium text-sm">{size.name}</div>
                            <div className="text-xs text-muted-foreground">{size.padding}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <TabsContent value="emptyStates" className="space-y-6">
                    <div>
                      <H4 className="mb-3">Empty State Variants</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                      <H4 className="mb-3">Empty State Layouts</H4>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        {config.emptyStates.layouts.map((layout) => (
                    ...
                    <div>
                      <H4 className="mb-3">Empty State Backgrounds</H4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {config.emptyStates.backgrounds.map((background) => (
                          <div key={background.id} className="p-3 border rounded-lg">
